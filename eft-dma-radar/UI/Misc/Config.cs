...
namespace eft_dma_radar.UI.Misc
{
    ...
    public sealed class Config : IConfig
    {
        ...
        [JsonPropertyName("mapFollowTeammate")]
        public int MapFollowTeammate { get; set; } = 0;
        ...
        /// </summary>
        [JsonIgnore] internal const string Filename = "Config-EFT-kek.json";
    ...
    public sealed class ContainersConfig
    {
        ...
        /// Select all stashes
        /// </summary>
        [JsonPropertyName("selectAllStashes")]
        public bool SelectAllStashes { get; set; } = false;
        /// <summary>
        ...
        /// Container Colors
        /// </summary>
        public Dictionary<ContainerColorOption, string> Colors { get; set; } = ContainerColorOptions.GetDefaultColors();
    }
